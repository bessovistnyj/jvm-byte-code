...
public class UserStore {
    ...
    private UserStore()  {
        ...
        this.selectQuery.load(loader.getResourceAsStream("delete.properties"));
        this.insertQuery.load(loader.getResourceAsStream("insert.properties"));
        this.deleteQuery.load(loader.getResourceAsStream("select.properties"));
    ...
    public void initDB() {
        try (Connection connection = this.ds.getConnection();
            ...
            statement.addBatch(this.createQuery.getValue("createTable"));
